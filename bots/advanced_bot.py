"""
Advanced Competition Bot for AWAP 2026 - Carnegie Cookoff

Features:
- Pre-computed 8-directional pathfinding (Chebyshev distance)
- Role-based multi-bot coordination (Chef/Support)
- Smart order prioritization
- Cooking timer tracking to prevent burns
- Sabotage protocol during switch window
- Defense protocol against enemy invasion
"""
